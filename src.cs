namespace WORDLE_PART_3
{
    public partial class WORDLE : Form
    {
        ...
        public void checkWord(RichTextBox richTextBox1, RichTextBox richTextBox2, Label label2)
        {
        ...
        public void checkWordLast(RichTextBox richTextBox6, Label label2)
        {
        ...
        private void richTextBox1_KeyDown(object sender, KeyEventArgs e)
        {
            if(e.KeyCode == Keys.Enter)
            {
                ...
                {
                    checkWord(richTextBox1, richTextBox2, label2);
                }
        ...
        private void richTextBox2_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                {
                    checkWord(richTextBox2, richTextBox3, label2);
        ...
        private void richTextBox3_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                {
                    checkWord(richTextBox3, richTextBox4, label2);
        ...
        private void richTextBox4_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                {
                    checkWord(richTextBox4, richTextBox5, label2);
        ...
        private void richTextBox5_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                {
                    checkWord(richTextBox5, richTextBox6, label2);
        ...
        private void richTextBox6_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                {
                    checkWordLast(richTextBox6, label2);
